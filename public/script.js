...
continue_btn.onclick = ()=>{
    info_box.classList.remove("activeInfo"); //hide info box
    document.querySelector(".userDetails").style.display = "none"; //hide user details
    document.querySelector(".border_box").style.display = "none"; //hide border box
...
function optionSelected(answer){
    ...
    if(userAns == correcAns){ //if user selected option is equal to array's correct answer
        ...
        userScore -=1*5; //degrading score value with 5
